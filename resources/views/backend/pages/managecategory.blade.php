...
<div class="br-pagetitle">
    ...
    <div>
      ...
      <p class="mg-b-0">Manage Your Category, You Can Edit Update And Delete Your Category</p>
    </div>
  </div>
      {{-- maincontant --}}
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <a href="" class=" btn btn-sm btn-success"><i class="fas fa-eye"></i></a> 
                                        ...
                                        <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#category{{$category->slug}}">
