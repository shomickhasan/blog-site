...
@section('content')
<div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('{{asset('backeend/blogimg/'. $blog->image)}}');">
    <div class="container">
        ...
        <div class="col-md-12 col-lg-10">
          <div class="post-entry text-center">
            ...
            <div class="post-meta align-items-center text-center">
              <figure class="author-figure mb-0 mr-3 d-inline-block"><img src="" class="img-fluid"></figure>
              <span class="d-inline-block mt-1 text-uppercase">{{$blog->users->name}}</span>
        ...
        <div class="col-md-12 col-lg-4 sidebar">
          ...
          <div class="sidebar-box">
            <div class="bio text-center">
              ...
              <div class="bio-body">
                <h3 class="text-uppercase">{{$blog->users->name}}</h3>
